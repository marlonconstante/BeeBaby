...
ThankYou = Obrigado!
ImmortalizeMomentsAndShare = Agora você pode eternizar os momentos do seu filho na internet e compartilhá-los com toda a família BeeBaby.
SynchronizedMoments = Utilize as mesmas credenciais em outro dispositivo que manteremos os momentos sincronizados.
...
ThankYou = Thank you!
ImmortalizeMomentsAndShare = Now you can immortalize moments of your child on the internet and share them with all BeeBaby family.
SynchronizedMoments = Use the same credentials on other device that will maintain the synchronized moments.
Timeline = Timeline
