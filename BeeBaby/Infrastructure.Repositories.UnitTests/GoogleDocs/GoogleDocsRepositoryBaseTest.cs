...
using Infrastructure.Repositories.GoogleDocs;
using System.Collections.Generic;

namespace Infrastructure.Repositories.UnitTests.GoogleDocs
{
	[TestFixture()]
	public class GoogleDocsRepositoryBaseTest
	{
		...
		{
			var target = new GoogleDocsRepositoryBase<Moment>("BeeBabyTest", "giusepe@gmail.com", "fnzjgmlensrvsgyd");
