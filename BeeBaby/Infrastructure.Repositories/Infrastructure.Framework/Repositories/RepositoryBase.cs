...
namespace Infrastructure.Framework.Repositories
{
	/// <summary>
		...
		: IRepository<TEntity>, IUnitOfWorkRepository where TEntity : IAggregateRoot 
    {
        ...
        #region Constructors
		/// <summary>
		/// Initializes a new instance of the <see cref="Infrastructure.Framework.Repositories.RepositoryBase&lt;TEntity, TKey&gt;"/> class.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the <see cref="Infrastructure.Framework.Repositories.RepositoryBase&lt;TEntity, TKey&gt;"/> with the specified key.
		/// </summary>
		/// <param name="key">Key.</param>
